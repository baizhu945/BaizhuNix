  ...
  home.file = {
    ".config/niri/config.kdl".text = ''
	  ...
	  Mod+Shift+T hotkey-overlay-title="Open a Terminal: kitty" { spawn "kitty" "-e" "zsh"; }
          ...
          Mod+Slash hotkey-overlay-title="Fast Search" { spawn "dms" "ipc" "call" "spotlight" "openQuery" "? "; }
          Mod+P hotkey-overlay-title="Show clipboard history" { spawn-sh "noctalia-shell ipc call launcher clipboard"; }
          //Mod+Shift+P hotkey-overlay-title="Screen Shot by grim" { spawn-sh "grim -g "$(slurp)" $(xdg-user-dir PICTURES)/Screenshots/$(date +'%s_grim.png')"; }
          // Mod+W hotkey-overlay-title="Run a Wallpaper Selector: Waypaper" { spawn "waypaper"; }
          ...
          // Mod+Shift+H hotkey-overlay-title="Hide the DesktopWidgets" { spawn-sh "noctalia ipc desktopWidgets disable"; }
          Mod+Ctrl+W { spawn-sh "chameleos --stroke-width 4 & noctalia-shell ipc call toast send '{\"title\":\"进入涂鸦模式\"}' & sleep 0.1 && chamel toggle"; }
          Mod+Shift+W { spawn-sh "noctalia-shell ipc call plugin:screen-toolkit annotate"; }
